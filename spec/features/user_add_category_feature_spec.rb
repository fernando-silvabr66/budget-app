...
RSpec.describe 'Feature User login', type: :feature do
  ...
  it 'Add category' do
    user = User.create!(name: 'John-Doe', email: 'mock@gmail.com', confirmed_at: Time.now, password: 'password',
  ...
  it 'Presence of Add category select field' do
    user = User.create!(name: 'John-Doe', email: 'mock2@gmail.com', confirmed_at: Time.now, password: 'password',
                        password_confirmation: 'password')
  ...
  it 'Presence of Add category name field' do
    user = User.create!(name: 'John-Doe', email: 'mock3@gmail.com', confirmed_at: Time.now, password: 'password',
                        password_confirmation: 'password')
